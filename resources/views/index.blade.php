...
<html lang="{{ $site->lang ?? 'en' }}" class="scroll-smooth" dir="ltr" data-theme="dark">
    ...
    <head>
        ...
        <meta name="description"
            content="A concise, 150-160 character summary of your page content to entice clicks from search results.">
    ...
    <body>
        <x-biblio::container>
            ...
            <x-slot:sidebar>
                <x-biblio::sidebar :links="$links" :item="$item" />
            </x-slot:sidebar />
